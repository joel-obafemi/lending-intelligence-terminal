...
tagline: "Aave V3 grew $845 million in June while its USDC book contracted. The paradox of consolidation under yield compression."
reading_time_min: 24
...
<InlineChart type="bar" title="Loan-to-Deposit Ratio by protocol: Euler V2 and Fluid run 20+ points above the pool-based cluster" x="protocol"
  unit="percent" series={["May 31","June 30"]}
  data={[
...
<InlineChart type="line" title="Real Yield Spread across 14 months: June 2026 re-inverts to −37 bps after May's parity" x="month"
  unit="bps" series={["Spread"]}
  data={[
    { month: "May 25", "Spread": -55 },
    { month: "Jun 25", "Spread": -90 },
    { month: "Jul 25", "Spread": 26 },
    { month: "Aug 25", "Spread": -19 },
    { month: "Sep 25", "Spread": 38 },
    { month: "Oct 25", "Spread": -41 },
    { month: "Nov 25", "Spread": -63 },
    { month: "Dec 25", "Spread": -8 },
    { month: "Jan 26", "Spread": -64 },
    { month: "Feb 26", "Spread": -151 },
    { month: "Mar 26", "Spread": -118 },
    { month: "Apr 26", "Spread": -28 },
    { month: "May 26", "Spread": 0 },
    { month: "Jun 26", "Spread": -37 }
  ]} />
...
<InlineChart type="line" title="Daily sector liquidations in June: June 5 spike of $128M, then a two-week quiet stretch" x="date"
  unit="usdm" series={["Collateral seized"]}
  data={[
    { date: "06/01", "Collateral seized": 1.68 },
    { date: "06/02", "Collateral seized": 12.27 },
    { date: "06/03", "Collateral seized": 12.76 },
    { date: "06/04", "Collateral seized": 22.69 },
    { date: "06/05", "Collateral seized": 128.31 },
    { date: "06/06", "Collateral seized": 56.67 },
    { date: "06/07", "Collateral seized": 0.16 },
    { date: "06/08", "Collateral seized": 0.04 },
    { date: "06/09", "Collateral seized": 0.69 },
    { date: "06/10", "Collateral seized": 0.04 },
    { date: "06/11", "Collateral seized": 0.01 },
    { date: "06/12", "Collateral seized": 0.0 },
    { date: "06/13", "Collateral seized": 0.04 },
    { date: "06/14", "Collateral seized": 0.0 },
    { date: "06/15", "Collateral seized": 0.0 },
    { date: "06/16", "Collateral seized": 0.01 },
    { date: "06/17", "Collateral seized": 1.42 },
    { date: "06/18", "Collateral seized": 3.79 },
    { date: "06/19", "Collateral seized": 0.01 },
    { date: "06/20", "Collateral seized": 0.0 },
    { date: "06/21", "Collateral seized": 0.0 },
    { date: "06/22", "Collateral seized": 0.0 },
    { date: "06/23", "Collateral seized": 6.04 },
    { date: "06/24", "Collateral seized": 2.93 },
    { date: "06/25", "Collateral seized": 9.17 },
    { date: "06/26", "Collateral seized": 0.95 },
    { date: "06/27", "Collateral seized": 0.45 },
    { date: "06/28", "Collateral seized": 0.33 },
    { date: "06/29", "Collateral seized": 0.03 },
    { date: "06/30", "Collateral seized": 0.16 }
  ]} />
...
<InlineChart type="bar" title="June 5 collateral seized by protocol: multi-protocol shock, not a single-venue failure" x="protocol"
  unit="usdm" series={["Collateral seized"]}
  data={[
    { protocol: "Aave V3", "Collateral seized": 93.98 },
    { protocol: "Fluid", "Collateral seized": 15.04 },
    { protocol: "Morpho", "Collateral seized": 11.08 },
    { protocol: "Compound V3", "Collateral seized": 7.22 },
    { protocol: "SparkLend", "Collateral seized": 0.96 },
    { protocol: "Euler V2", "Collateral seized": 0.02 }
  ]} />
...
<InlineChart type="bar" title="Aave V3 absorbed 63% of sector net inflow; five of six protocols were positive" x="protocol"
  unit="usdm" series={["Net flow"]}
  data={[
    { protocol: "Aave V3", "Net flow": 845 },
    { protocol: "SparkLend", "Net flow": 415 },
    { protocol: "Compound V3", "Net flow": 59 },
    { protocol: "Morpho", "Net flow": 20 },
    { protocol: "Fluid", "Net flow": 16 },
    { protocol: "Euler V2", "Net flow": -21 }
  ]} />
...
<InlineChart type="bar" title="Aave V3 net flow by asset: wstETH, cbBTC, USDTB and USDT drove the inflow; USDC shed $162M" x="asset"
  unit="usdm" series={["Net flow"]}
  data={[
    { asset: "wstETH", "Net flow": 452 },
    { asset: "USDC", "Net flow": -162 },
    { asset: "cbBTC", "Net flow": 143 },
    { asset: "USDTB", "Net flow": 104 },
    { asset: "USDT", "Net flow": 99 },
    { asset: "rsETH", "Net flow": -55 },
    { asset: "USDE", "Net flow": 48 },
    { asset: "SUSDE", "Net flow": 46 },
    { asset: "WBTC", "Net flow": 44 },
    { asset: "WETH", "Net flow": 43 },
    { asset: "DAI", "Net flow": -31 },
    { asset: "weETH", "Net flow": 30 }
  ]} />
...
<InlineChart type="bar" title="Morpho curator shares (V1+V2 combined): Sentora 31%, Steakhouse 29%, Gauntlet 14%, long tail below 6%" x="curator"
  unit="percent" series={["Share"]}
  data={[
...
<Lead>Euler V2 was the only protocol in coverage with net constant-price outflow in June, at $21 million. The magnitude is small in absolute terms and small relative to Euler V2's own May reading of $339 million net outflow.</Lead>
