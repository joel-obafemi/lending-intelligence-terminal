/**
 * One-shot — spark daily constant-price net supply flow for June 2026,
 ...
 *
 * Output: content/snapshots/2026-06-spark-daily-flows.csv (CSV, header
 ...
 *   data path:
 *
 *   1. Pull spark protocol history from DefiLlama (chainTvls.Ethereum
...
const OUTPUT_PATH = "content/snapshots/2026-06-spark-daily-flows.csv"
...
async function main(): Promise<void> {
  ...
  console.log(`spark June 2026 daily flows (constant-price methodology)`)
  console.log("")

  console.log("[1/3] Fetching DefiLlama spark protocol history …")
