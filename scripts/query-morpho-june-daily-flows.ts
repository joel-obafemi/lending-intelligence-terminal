/**
 * One-shot — morpho daily constant-price net supply flow for June 2026,
 ...
 *
 * Output: content/snapshots/2026-06-morpho-daily-flows.csv (CSV, header
...
const OUTPUT_PATH = "content/snapshots/2026-06-morpho-daily-flows.csv"
...
async function main(): Promise<void> {
  ...
  console.log(`morpho June 2026 daily flows (constant-price methodology)`)
  console.log("")
