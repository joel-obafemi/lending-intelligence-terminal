/**
 * One-shot — compound-v3 daily constant-price net supply flow for July 2026,
 ...
 *
 *   npm run query:compound-v3-july-daily-flows
 *
 * Output: content/snapshots/2026-07-compound-v3-daily-flows.csv (CSV, header
...
const OUTPUT_PATH = "content/snapshots/2026-07-compound-v3-daily-flows.csv"
...
async function main(): Promise<void> {
  ...
  console.log(`compound-v3 July 2026 daily flows (constant-price methodology)`)
  console.log("")
