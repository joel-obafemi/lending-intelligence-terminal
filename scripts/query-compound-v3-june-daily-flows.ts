/**
 * One-shot — compound-v3 daily constant-price net supply flow for June 2026,
 ...
 *
 * Output: content/snapshots/2026-06-compound-v3-daily-flows.csv (CSV, header
 ...
 *   data path:
 *
 *   1. Pull compound-v3 protocol history from DefiLlama (chainTvls.Ethereum
...
// ─── Constants ───────────────────────────────────────────────────────────
const PROTOCOL_DEFILLAMA_SLUG = "compound-v3"
...
const OUTPUT_PATH = "content/snapshots/2026-06-compound-v3-daily-flows.csv"
...
async function main(): Promise<void> {
  ...
  console.log(`compound-v3 June 2026 daily flows (constant-price methodology)`)
  console.log("")

  console.log("[1/3] Fetching DefiLlama compound-v3 protocol history …")
