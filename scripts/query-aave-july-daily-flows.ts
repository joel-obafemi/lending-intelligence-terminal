/**
 * One-shot — Aave V3 daily constant-price net supply flow for July 2026,
 * with a WEETH-specific column. For Issue 004's Product Divergence
 * thesis (Morpho Midnight / V2 Markets launch, July 24).
 *
 *   npm run query:aave-july-daily-flows
 *
 * Output: content/snapshots/2026-07-aave-daily-flows.csv (CSV, header
 ...
 *   data path:
 *
 *   1. Pull Aave V3 protocol history from DefiLlama (chainTvls.Ethereum
...
const OUTPUT_PATH = "content/snapshots/2026-07-aave-daily-flows.csv"
...
async function main(): Promise<void> {
  ...
  console.log(`Aave V3 July 2026 daily flows (constant-price methodology)`)
  console.log("")
