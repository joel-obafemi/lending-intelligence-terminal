/**
 * Sector-wide oracle concentration at June 30, 2026 — for Issue 002 §08.
 *
 *   npm run query:oracle-concentration-may
 *
 ...
 * six-protocol scope at June 30, 2026.
 *
 * Methodology:
 ...
 *
 * Output: content/snapshots/2026-06-oracle-concentration.json
 */
...
const OUTPUT_PATH = "content/snapshots/2026-06-oracle-concentration.json"
...
async function main(): Promise<void> {
  ...
  // ─── Console summary ────────────────────────────────────────────────
  console.log("── Sector-wide oracle share at June 30, 2026 ───────────────")
  for (const v of ALL_VENDORS) {
