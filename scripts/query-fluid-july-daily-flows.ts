/**
 * One-shot — fluid daily constant-price net supply flow for July 2026,
 * with a WEETH-specific column. For Issue 004's Product Divergence
 * thesis (Morpho Midnight / V2 Markets launch, July 24).
 *
 *   npm run query:fluid-july-daily-flows
 *
 * Output: content/snapshots/2026-07-fluid-daily-flows.csv (CSV, header
...
const OUTPUT_PATH = "content/snapshots/2026-07-fluid-daily-flows.csv"
...
async function main(): Promise<void> {
  ...
  console.log(`fluid July 2026 daily flows (constant-price methodology)`)
  console.log("")
