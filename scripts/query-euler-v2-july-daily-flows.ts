/**
 * One-shot — euler-v2 daily constant-price net supply flow for July 2026,
 ...
 *
 *   npm run query:euler-v2-july-daily-flows
 *
 * Output: content/snapshots/2026-07-euler-v2-daily-flows.csv (CSV, header
...
const OUTPUT_PATH = "content/snapshots/2026-07-euler-v2-daily-flows.csv"
...
async function main(): Promise<void> {
  ...
  console.log(`euler-v2 July 2026 daily flows (constant-price methodology)`)
  console.log("")
