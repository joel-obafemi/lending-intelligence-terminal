/**
 * One-shot — euler-v2 daily constant-price net supply flow for June 2026,
 ...
 *
 * Output: content/snapshots/2026-06-euler-v2-daily-flows.csv (CSV, header
 ...
 *   data path:
 *
 *   1. Pull euler-v2 protocol history from DefiLlama (chainTvls.Ethereum
...
// ─── Constants ───────────────────────────────────────────────────────────
const PROTOCOL_DEFILLAMA_SLUG = "euler-v2"
...
const OUTPUT_PATH = "content/snapshots/2026-06-euler-v2-daily-flows.csv"
...
async function main(): Promise<void> {
  ...
  console.log(`euler-v2 June 2026 daily flows (constant-price methodology)`)
  console.log("")

  console.log("[1/3] Fetching DefiLlama euler-v2 protocol history …")
