/**
 * Per-asset decomposition of the biggest June 2026 net-supply outflow days
 * on Aave V3 Ethereum — for Issue 003 (June 30, 2026 data capture).
 ...
 * inspecting June daily-flows output.
 *
 *   npm run query:aave-outflow-days-by-asset
 *
 ...
 *
 * Output: content/snapshots/2026-06-aave-outflow-days-by-asset.json
 */
...
const TARGET_DAYS_UTC = ["2026-06-15"]
const OUTPUT_PATH = "content/snapshots/2026-06-aave-outflow-days-by-asset.json"
...
async function main(): Promise<void> {
  console.log("Aave V3 — per-asset breakdown of the three biggest May 2026 outflow days")
  console.log("")
